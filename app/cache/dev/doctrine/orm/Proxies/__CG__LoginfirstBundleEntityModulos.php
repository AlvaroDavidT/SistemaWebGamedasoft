 ...
 */
class Modulos extends \Login\firstBundle\Entity\Modulos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Login\\firstBundle\\Entity\\Modulos' . "\0" . 'id', '' . "\0" . 'Login\\firstBundle\\Entity\\Modulos' . "\0" . 'nombre', '' . "\0" . 'Login\\firstBundle\\Entity\\Modulos' . "\0" . 'descripcion', '' . "\0" . 'Login\\firstBundle\\Entity\\Modulos' . "\0" . 'estado'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Modulos $proxy) {
