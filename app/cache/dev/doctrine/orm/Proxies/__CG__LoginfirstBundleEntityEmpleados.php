 ...
 */
class Empleados extends \Login\firstBundle\Entity\Empleados implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'id', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'nombre', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'apellido', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'cidentidad', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'password', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'email', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'telefono', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'foto', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'direccion', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'genero', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'departamentos', '' . "\0" . 'Login\\firstBundle\\Entity\\Empleados' . "\0" . 'perfiles'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Empleados $proxy) {
    ...
    public function setCidentidad($cidentidad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCidentidad', [$cidentidad]);
    ...
    public function getCidentidad()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCidentidad', []);
